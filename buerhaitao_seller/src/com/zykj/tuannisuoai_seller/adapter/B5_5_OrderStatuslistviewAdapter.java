...
public class B5_5_OrderStatuslistviewAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
    	...
    	try {
    			...
    			String goods_image_url = extend_order_goods1.getString("goods_image");
    			ImageLoader.getInstance().displayImage(goods_image_url, viewHolder.iv_product_Image);//设置产品图片
